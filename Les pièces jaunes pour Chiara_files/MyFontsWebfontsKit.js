...
var count=document.createElement('script');count.type='text/javascript';count.async=true;count.src='//hello.myfonts.net/count/2827f9';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if(typeof(woffEnabled)=='undefined'){var woffEnabled=true;}
...
suffix="_unhinted";var fonts=[{"fontFamily":"ProximaNova-Light","url":wfpath+"2827F9_0"+suffix+"_0."+webfontType},{"fontFamily":"ProximaNova-Semibold","url":wfpath+"2827F9_1"+suffix+"_0."+webfontType},{"fontFamily":"ProximaNova-Regular","url":wfpath+"2827F9_2"+suffix+"_0."+webfontType},{"fontFamily":"ProximaNova-Bold","url":wfpath+"2827F9_3"+suffix+"_0."+webfontType}];var len=fonts.length;if(webfontType=="ttf"){var data_fn=suffix=="_unhinted"?"2827F9_data_unhintedttf.css":"2827F9_datattf.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
else if(webfontType=="woff"){var data_fn=suffix=="_unhinted"?"2827F9_data_unhintedwoff.css":"2827F9_datawoff.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
